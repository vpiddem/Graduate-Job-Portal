...
class JobApplicationsControllerTest < ActionController::TestCase
  ...
  test "should create job_application" do
    assert_difference('JobApplication.count') do
      post :create, job_application: { application_deadline: @job_application.application_deadline, cover_letter: @job_application.cover_letter, job_id: @job_application.job_id, job_seeker_id: @job_application.job_seeker_id, status: @job_application.status }
    end
  ...
  test "should update job_application" do
    patch :update, id: @job_application, job_application: { application_deadline: @job_application.application_deadline, cover_letter: @job_application.cover_letter, job_id: @job_application.job_id, job_seeker_id: @job_application.job_seeker_id, status: @job_application.status }
    assert_redirected_to job_application_path(assigns(:job_application))
  end
